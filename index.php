...
<body>
    <nav class="navbar navbar-default" role="navigation">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#"><strong>CHEFA</strong> Shopping</a>
            </div>
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="#"><strong>Call: </strong>+94717089895</a></li>
                            <li><a href="#"><strong>Mail: </strong>info@chefashopping.com</a></li>
                            <li class="divider"></li>
                            <li><a href="#"><strong>Address: </strong>
                                <div>
                                    234, Kotugodalla Street,<br />
                                     Kandy , Sri Lanka
                                </div>
                            </a></li>
                        </ul>
        ...
        <div class="row">
            <div class="col-md-9">
                ...
                <div class="main box-border">
                    ...
                    <img src="1.png" class="image" height=100% width=100%>
                    <img src="2.jpg" class="image" height=100% width=100%>
                    <img src="3.jpg" class="image" height=100% width=100%>
                    <img src="4.jpg" class="image" height=100% width=100%>
                    <img src="5.jfif" class="image" height=100% width=100%>
                    <img src="6.jpg" class="image" height=100% width=100%>
                    <img src="7.jpg" class="image" height=100% width=100%>
            ...
            <div class="col-md-4">
                ...
                <p>
                     234, Kotugodalla Street,<br />
                                    Kandy, Sri Lanka<br />
                    Call: +94717089895<br>
                    Email: info@chefashopping.com<br>
                </p>
    ...
    <div class="col-md-12 end-box ">
        &copy; 2014 | &nbsp; All Rights Reserved | &nbsp; www.chefashopping.com | &nbsp; 24x7 support | &nbsp; Email us: info@chefashopping.com
    </div>
    <!-- /.col -->
    <!--Footer end -->
